...
namespace GymManagement.Utilities
{
    public static class ResizeImage
    {
        ...
        /// <summary>
        /// This code maintains aspect ratio so for example, a tall, narrow image will 
            ...
            int max_height = 75, int max_width = 90)
        {
            ...
            // The bitmap to fill the surface
        ...
        /// <param name="selectedFormat">Default format is set to Webp but it can change that with this parameter</param>
