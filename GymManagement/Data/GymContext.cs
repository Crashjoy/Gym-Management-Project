...
namespace GymManagement.Data
{
    public class GymContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //prevented from deleting a FitnessCategory with
            ...
            //prevented from deleting a Client who is
            //Enrolled in any Group Classes.
            //But cascade delete from GroupClass
            //to Enrollment is allowed, so if a class is deleted, the related
            //enrollment records are cleaned up as well.
            //Note: Cascade delete from Client 
            //to Workout is allowed
            ...
            //2 New Many to Many Intersections 
