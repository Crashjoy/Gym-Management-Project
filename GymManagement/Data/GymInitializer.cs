                ...
                serviceProvider.GetRequiredService<DbContextOptions<GymContext>>()))
            {
                ...
                try
                {
                    ...
                    if (!context.Exercises.Any())
                    {
                        ...
                        context.SaveChanges();
                        //One exercise (push - ups) was added to Personal Training earlier, so we also need to
                        //associate with High Intensity Interval Training
                        ...
                        //Strength Training
                        //Need to associate them with the additional Fitness Category
                ...
                if (SeedSampleData)
                {
                    ...
                    try
                    {
                        // Seeds Instructors if there aren't any.
                    ...
                    //Adds more Instructors
                    if (context.Instructors.Count() < 5)
                    {
                        foreach (string lastName in lastNames)
                        {
                            //Chooses a random HashSet of 5 first names
                            ...
                            {
                                //Constructs some Instructor details
                    ...
                    //Add Cleints with security login
                    ...
                    //Uses a different collection of Last Names
                    ...
                    //Need a collection of the primary keys and Fees of the Membership Types
                    ...
                    //Chooses a random HashSet of 10 last names
                    ...
                    if (context.Clients.Count() < 5)
                    {
                        ...
                        {
                            //Chooses a random HashSet of 10 first names
                            HashSet<string> selectedFirstNames = new HashSet<string>();
                            ...
                            foreach (string firstName in selectedFirstNames)
                            {
                                //Need to set a couple of choices for the client before we start building the object
                                DateTime memStartDate = startDate.AddDays(-random.Next(300));
                                int membershipTypeOrdinal = random.Next(memTypeIDCount);

                                //Constructs some Client details
                                Client client = new Client()
                                {
                                    MembershipNumber = 10001 + counter,
                                    FirstName = firstName,
                                    LastName = lastName,
                    ...
                    //Need an array of values from our Enum
                    Array valuesDOW = Enum.GetValues(typeof(DOW));
                    

                    //Need a collection of the primary keys of the Fitness Categories
                    ...
                    //Creates 10 intensity modifiers for describing group classes
                    ...
                    //Adds More GroupClasses
                    if (context.GroupClasses.Count() < 4)
                    {
                        //Creates up to 30 more group classes
                        for (int i = 0; i < 30; i++)
                        {
                            //Chooses the fitness category
                    ...
                    if(!context.Workouts.Any()) //Adds Workouts for each Client
                    {
                        ...
                        {                            
                            ...
                            for (int j = 1; j <= howMany; j++)
                            {
                                ...
                                //Now adds few WorkoutExercises to the workout
