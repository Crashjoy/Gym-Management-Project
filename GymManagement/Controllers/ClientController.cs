        ...
        public IActionResult MembershipTypeReport()
        {
            ...
            if (numRows > 0) //We have data
            {
                ...
                using (ExcelPackage excel = new ExcelPackage())
                {
                    ...
                    var cell33 = workSheet.Cells[3, 1];
                    cell33.RichText.Clear(); //Incase you're running this multiple times and don't want duplicate text.
                    cell33.RichText.Add("Of Clients");
                    var counRun = cell33.RichText.Add("Number");
